...
public class LoggingGlobalFilter implements GlobalFilter, Ordered {
    ...
    private final static String LOG = "[RouteId: {}] Request [origin : {}, uri: {}, method: {}, headers: {}] routed to [uri: {}, method: {}, headers: {}] with response [status: {}]";

    @Override
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {

        // Récupération des attributs de la requête originale passés par EntryGlobalFilter
        String origin = resolveCallerAddress(exchange);
    ...
    public String resolveCallerAddress (ServerWebExchange exchange) {
